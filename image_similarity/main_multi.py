...
from image_similarity.model_util import DeepModel, DataSequence
...
if __name__ == '__main__':
    ...
    '''Load source data'''
    test1 = similarity.load_data_csv('./demo/test2.csv', delimiter=',', cols=['id', 'path'])
    test2 = similarity.load_data_csv('./demo/test2.csv', delimiter=',', cols=['id', 'path'])
